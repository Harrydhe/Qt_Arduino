    ...
    , ui(new Ui::Dialog)
{
    ...
    pix = QPixmap(":/src/radar.png").scaled(QSize(945, 495), Qt::KeepAspectRatio);
...
void Dialog::readSerial(){
    ...
    if (bufferSplit.length() < 3){
        ...
        ui->label_2->setText(bufferSplit[1]);
        currAngle = ui->label->text().toFloat();
...
void Dialog::on_verticalSlider_valueChanged(int value)
{
    ...
    ui->label->setText(servoSetting_str);
